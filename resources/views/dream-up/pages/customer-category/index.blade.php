...
@section('content')
    <div class="bg-white w-[96%] h-36 font-gilroy mt-6 rounded-md shadow-lg">
        ...
        <div class="relative w-full ml-4 flex items-center text-sm">
            ...
            <a href="{{ route('cm-cat-create') }}" class="px-4 py-2 ml-4 bg-white border border-blue-600 text-blue-600 font-gilroy rounded-md cursor-pointer hover:bg-blue-600 hover:text-white">Thêm nhóm khách hàng</a>
        </div>
    </div>
