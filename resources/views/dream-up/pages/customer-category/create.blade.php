...
@section('content')
    <div class="bg-white h-16 w-full flex">
        ...
        <div class="flex items-center justify-end w-[68%] 2xl:w-[72%]">
            <a href="{{ route('cm-cat-index') }}" class="w-[10%] px-4 py-2 ml-4 bg-white border border-blue-600 text-blue-600 font-gilroy rounded-md cursor-pointer hover:bg-blue-600 hover:text-white text-center">Hủy</a>
            <button type="submit" form="cm-cat-form-create" class="w-[10%] px-4 py-2 ml-4 bg-white border border-green-600 text-green-600 font-gilroy rounded-md cursor-pointer hover:bg-green-600 hover:text-white text-center">Lưu</button>
        </div>
    </div>

    <form action="{{ route('cm-cat-store') }}" id="cm-cat-form-create" method="POST" class="w-[96%] flex justify-between">
        @csrf
        ...
        <div class="bg-white w-[49%] h-full font-gilroy mt-6 rounded-md shadow-lg">
            ...
            <div class="w-full mt-4">
                ...
                <div class="w-full px-6 mt-4">
                    ...
                    <input class="text-right mt-2 w-full pl-3 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="text" placeholder="Nhập mã nhóm sản phẩm" name="discountPercent" value="{{old('discountPercent', 0)}}" >
                </div>
                <div class="w-full px-6 mt-4">
