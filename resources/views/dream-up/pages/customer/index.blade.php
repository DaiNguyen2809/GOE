...
@section('content')
    <div class="bg-white w-[96%] h-36 font-gilroy mt-6 rounded-md shadow-lg">
        ...
        <div class="relative w-full ml-4 flex items-center text-sm">
            ...
            <input oninput="handleSearchData('cm-input', '{{ route('cm-search') }}', 'cm-container')" id="cm-input" placeholder="Tìm kiếm theo mã khách hàng, tên, SĐT khách hàng" class="w-[40%] pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <a href="{{ route('cm-create') }}" class="px-4 py-2 ml-4 bg-white border border-blue-600 text-blue-600 font-gilroy rounded-md cursor-pointer hover:bg-blue-600 hover:text-white">Thêm khách hàng</a>
        </div>
    </div>
