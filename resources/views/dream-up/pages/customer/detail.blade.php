...
@section('content')
    <div class="bg-white h-fit w-full flex px-3 py-3">
        ...
        <div class="h-full flex items-center justify-end w-[68%] 2xl:w-[74%] text-sm">
            <button onclick="handleConfirmDelete('{{ $customer->id }}', 'cm-modal-delete', 'cm-form-delete', '{{ route('cm-destroy', '__id__') }}')" class="w-[18%] 2xl:w-[7%] px-4 py-2 ml-4 bg-white border border-red-600 text-red-600 font-gilroy rounded-md cursor-pointer hover:bg-red-600 hover:text-white text-center">Xóa khách hàng</button>
            <a href="{{ route('cm-edit', $customer->id) }}" class="w-[25%] 2xl:w-[7%] px-4 py-2 ml-4 bg-white border border-green-600 text-green-600 font-gilroy rounded-md cursor-pointer hover:bg-green-600 hover:text-white text-center"><i class="ml-2 fa-pen-to-square"></i>  Cập nhật khách hàng</a>
            <button type="submit" class="w-[25%] 2xl:w-[7%] px-4 py-2 ml-4 bg-white border border-blue-600 text-blue-600 font-gilroy rounded-md cursor-pointer hover:bg-blue-600 hover:text-white text-center">Tạo phiếu thu/chi <i class="ml-2 fa-regular fa-square-caret-down"></i></button>
        </div>
    </div>
