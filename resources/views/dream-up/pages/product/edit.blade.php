...
@section('content')
    <div class="bg-white h-full w-full flex px-3 py-3">
        <div class="h-full w-[30%] 2xl:w-[25%] flex items-center cursor-pointer group">
            ...
            <a href="{{ route('pd-show', $product->SKU) }}" class="ml-2 text-base text-gray-500 group-hover:underline">Quay lại chi tiết sản phẩm</a>
        </div>
        <div class="h-full flex items-center justify-end w-[68%] 2xl:w-[74%]">
            <a href="{{ route('pd-show', $product->SKU) }}" class="text-sm w-[11%] 2xl:w-[6%] h-10 px-4 py-2 ml-4 bg-white border border-blue-600 text-blue-600 font-gilroy rounded-md cursor-pointer hover:bg-blue-600 hover:text-white text-center"><i class="fa-solid fa-ban mr-2"></i> Hủy</a>
            <a href="{{ route('pd-index') }}" class="text-sm w-[22%] 2xl:w-[12%] h-10 px-4 py-2 ml-4 bg-white border border-green-600 text-green-600 font-gilroy rounded-md cursor-pointer hover:bg-green-600 hover:text-white text-center"><i class="fa-solid fa-qrcode mr-2"></i>Lưu và in mã vạch</a>
            <button type="submit" form="pd-form-update" class="text-sm w-[11%] 2xl:w-[6%] h-10 px-4 py-2 ml-4 bg-white border border-green-600 text-green-600 font-gilroy rounded-md cursor-pointer hover:bg-green-600 hover:text-white text-center"><i class="fa-solid fa-check mr-2"></i> Lưu</button>
        </div>
    </div>
    <form action="{{ route('pd-update', $product->SKU) }}" id="pd-form-update" method="POST" class="w-[96%] flex flex-wrap gap-6 mb-16 text-sm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="bg-white w-[65%] h-fit font-gilroy rounded-md shadow-lg">
                ...
                <div class="w-full mt-4">
                    <div class="w-full px-6">
                        ...
                        <input class="h-10 mt-2 w-full pl-3 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="text" placeholder="Nhập tên sản phẩm" name="name" value="{{ old('name', $product->name) }}">
                    </div>
                    <div class="w-full px-6 mt-4 flex justify-between">
                        <div class="w-[49%]">
                            ...
                            <input class="h-10 mt-2 w-full pl-3 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="text" placeholder="Nhập mã sản phẩm/SKU" name="SKU" value="{{ old('SKU', $product->SKU) }}">
                        </div>
                        <div class="w-[49%]">
                            ...
                            <input class="text-right h-10 mt-2 w-[78%] pl-3 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="number" name="weight" value="{{ number_format(old('weight', $product->weight ?? 0), 0, ',', '') }}">
                            <select name="unit_weight" class="inline-block mt-2 w-[20%] h-10 pl-3 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right">
                    ...
                    <div class="w-full px-6 mt-4 flex justify-between">
                        <div class="w-[49%]">
                            ...
                            <input class="h-10 mt-2 w-full pl-3 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="text" placeholder="Nhập mã vạch/barcode" name="barcode" value="{{ old('barcode', $product->barcode) }}">
                        </div>
                        <div class="w-[49%]">
                            ...
                            <select name="unit_package" class="h-10 inline-block mt-2 w-full pl-3 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="w-full flex justify-between h-[30%]">
            ...
            <div class="bg-white w-[46%] 2xl:w-[59%] h-fit pb-8 font-gilroy rounded-md shadow-lg">
