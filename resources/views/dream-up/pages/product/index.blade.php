...
@section('content')
    <div class="bg-white w-[96%] h-36 font-[gilroy] mt-6 rounded-md shadow-lg">
        ...
        <div class="relative w-full ml-4 flex items-center text-sm">
            ...
            <input oninput="handleSearchData('pd-input', '{{ route('pd-search') }}', 'pd-container')" id="pd-input" type="text" placeholder="Tìm kiếm theo mã sản phẩm, tên sản phẩm, barcode" class="w-[40%] pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
    ...
    <div class="bg-white w-[96%] h-screen font-[gilroy] mt-4 mb-6 rounded-md shadow-lg flex justify-center">
        <div class="container w-[98%] mt-4">
            <div id="pd-container" class="bg-white shadow-md overflow-hidden">
