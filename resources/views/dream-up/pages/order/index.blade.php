...
@section('content')
    <div class="bg-white w-[96%] h-64 font-gilroy mt-6 rounded-md shadow-lg">
        <h1 class="text-2xl font-gilroy_md mt-4 mb-2 ml-4">QUẢN LÝ ĐƠN HÀNG</h1>
        <div class="relative w-full ml-4 flex items-center text-sm">
            ...
            <input oninput="handleSearchData('od-input', '{{ route('od-search') }}', 'od-container')" id="od-input" type="text" placeholder="Tìm kiếm theo mã đơn hàng, tên, SĐT khách hàng/người nhận hàng" class="w-[40%] h-10 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            <select class="h-10 cursor-pointer ml-4 border border-gray-300 rounded-lg py-2.5 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <a href="{{ route('od-create') }}" class="h-10 px-4 py-2 ml-4 bg-white border border-blue-600 text-blue-600 font-[gilroy] rounded-md cursor-pointer hover:bg-blue-600 hover:text-white"><i class="fa-solid fa-plus mr-2"></i> Tạo đơn hàng</a>
        </div>
