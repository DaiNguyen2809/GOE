            ...
            <div class="w-full mt-4">
                <form action="{{ route('pd-cat-update', $productCategory->id) }}" id="pd-cat-form-update" method="POST">
                    ...
                    <div class="w-full px-6">
                        ...
                        <input class=" mt-2 w-full pl-3 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="text" placeholder="Nhập tên nhóm sản phẩm" name="name" value="{{ old('name', $productCategory->name) }}">
                    </div>
                    <div class="w-full px-6 mt-4">
                        ...
                        <input class="mt-2 w-full pl-3 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="text" placeholder="Nhập mã nhóm sản phẩm" name="id" value="{{ old('id', $productCategory->id) }}">
                    </div>
                    <div class="w-full px-6 mt-4">
